"""
This model will determine the house style of given image   modern/vintage
...
os.listdir('dataset_model1')
os.listdir('dataset_model1/pic_train')
...
test = []
for file in get_files('dataset_model1/pic_test'):
    img = cv2.imread(file)
...
train_gen = datagen.flow_from_directory('dataset_model1/pic_train', target_size=image_shape[:2],
                                        color_mode='rgb', batch_size=batch_size, class_mode='binary')
test_gen = datagen.flow_from_directory('dataset_model1/pic_test', target_size=image_shape[:2],
                                         color_mode='rgb', batch_size=batch_size, class_mode='binary')
...
model.evaluate(test)
tf.saved_model.save(model, "Home_style_binary_classification")

# # Predict on the test data
# predictions = model.predict(test)
# print(predictions)
#
# # Round the probabilities to the nearest integer (0 or 1)
